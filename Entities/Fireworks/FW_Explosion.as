...
namespace Fireworks
{
    ...
    {        
        ...
        CParticle@ bullet = ParticlePixel( at, Vec2f(-5+XORRandom(11),-11+-(XORRandom(80)*0.1)),  SColor(255, 0,0,0), true );
    ...
    void Explode(Vec2f at, Vec2f velin)
    {
        ...
        */
        ...
        {              
            ...
            int amount = 20; // Amount of Pixels.
        ...
        if (type == 1) // big round perfect spacing
        {
            ...
            int amount = 24; // Amount of Pixels.
        ...
        {            
            int amount = 15; // Amount of Pixels.
            for (int i = 0; i < amount; i++)
            {
                Vec2f pos = at;
    ...
    void MakeGreenFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
        texture = "particle_trail_green.png";
        
        CParticle@ p = ParticleAnimated( texture, pos, Vec2f_zero, 0.0f, 1.0f, 1 + _r.NextRanged(3), -0.0f, true );
    ...
    void MakeBlueFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
    ...
    void MakePurpleFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
        texture = "particle_trail_purple.png";
    ...
    void MakeDarkBFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
        texture = "particle_trail_darkblue.png";
    ...
    void MakeRedFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
        texture = "particle_trail_red.png";
    ...
    void MakeTealFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
        texture = "particle_trail_teal.png";
    ...
    void MakeOrangeFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
        texture = "particle_trail_orange.png";
    ...
    void MakeGreyFireTrail(Vec2f pos)  //, int amount, Vec2f vel)
    {
        string texture;
        texture = "particle_trail_grey.png";
