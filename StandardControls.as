...
void AdjustCamera(CBlob@ this, bool is_in_render)
{
	...
	f32 minZoom = 0.625f; // TODO: make vars
	f32 maxZoom = 0.625f;

	f32 zoom_target = 0.625f;

	if (zoomModifier) {
		switch (zoomModifierLevel) {
			case 0:	zoom_target = 0.625f; zoomLevel = 0; break;
			case 1: zoom_target = 0.625f; zoomLevel = 0; break;
			case 2: zoom_target = 0.625f; zoomLevel = 0; break;
			case 3: zoom_target = 0.625f; zoomLevel = 0; break;
			case 4: zoom_target = 0.625f; zoomLevel = 1; break;
			case 5: zoom_target = 0.625f; zoomLevel = 1; break;
			case 6: zoom_target = 0.625f; zoomLevel = 2; break;
		}
	} else {
		switch (zoomLevel) {
			case 0: zoom_target = 0.625f; zoomModifierLevel = 0; break;
			case 1: zoom_target = 0.625f; zoomModifierLevel = 4; break;
			case 2:	zoom_target = 0.625f; zoomModifierLevel = 6; break;
		}
	}
